...
use crate::value::convert::{value_to_point, value_to_polygon};
...
impl Polygon {
    ...
    pub fn put_polygon(&self, setting_code: &str, key: Arc<str>, value: Value) -> bool {
    ...
    pub fn remove_polygon(&self, setting_code: &str, key: Arc<str>, value: Value) -> bool {
        ...
        let Ok((id, _polygon)) = value_to_polygon(&value) else {
            return false;
        };
    ...
    pub fn contains_polygon(
        ...
        let polygon_key = PolygonKey::new(Arc::<str>::from(setting_code), Arc::<str>::from(key));
